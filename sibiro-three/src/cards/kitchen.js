  ...
  render() {
    return (
      ...
      <p id="newEl">
        ...
        <p style={{margin:'3%',fontSize:"20px",maxWidth:'100%',width:"900px"}}>Встраиваемые кухни по индивидуальным размерам! Уникальная разметка, под планировку квартиры.</p>
        <p style={{margin:'3%',fontSize:"20px",maxWidth:'100%',width:"900px"}}>Качество, долговечность и функциональность мебели на заказ с использованием современных технологий. Грамотно организуем пространство. Любые площади используем с максимальной пользой.</p>
